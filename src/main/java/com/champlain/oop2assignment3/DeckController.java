...
public class DeckController {
    ...
    protected void onScoreButtonClick() {
        ...
        if (choice == null) {
            ...
            ScoringStrategie strategy;
            switch (choice) {
                case "Simple Count":
                    strategy = new CalculateSimple();
                    int numofcount = strategy.calculateScore(this.aHand);
                    this.aScoreLabel.setText(" Simple count " + numofcount);
                    break;
                case "Number Of Aces":
                    strategy = new CalculateAces();
                    int numoface = strategy.calculateScore(this.aHand);
                    this.aScoreLabel.setText("Number of aces " + numoface);
                    break;
                default:
